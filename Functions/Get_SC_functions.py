"""
L. Viens 02/29/2018
This function computes Single-station Cross-correlation (SC) functions from the data recorded by the vertical and horizontal components at one seismic station.
It is an example of the paper Viens et al. (2018) JGR.
...
def get_SC_functions(dat_Z, dat_HZ, delta, len_corr):
        """
    ...
    INPUT: 
        ...
        - len_corr = Lenght of the SC function in second (as the causal and acausal parts of the SC function are computed, the total length in 2 times len_corr)
    OUTPUT:
